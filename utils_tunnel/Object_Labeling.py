...
def ObjectLabeling(client,map_id,name2idx):
    ...
    found = client.simSetSegmentationObjectID("[\w]*Floor[\w]*", 5, True)
    found = client.simSetSegmentationObjectID("[\w]*Cube[\w]*", 5, True)
    ...
    found = client.simSetSegmentationObjectID("[\w]*wallbox[\w]*", 25, True)
    found = client.simSetSegmentationObjectID("[\w]*fusebox[\w]*", 25, True)
    found = client.simSetSegmentationObjectID("[\w]*switch[\w]*", 25, True)
    found = client.simSetSegmentationObjectID("[\w]*Tank[\w]*", 25, True)

    found = client.simSetSegmentationObjectID("[\w]*door[\w]*", 20, True)
    found = client.simSetSegmentationObjectID("[\w]*Door[\w]*", 20, True)
    found = client.simSetSegmentationObjectID("[\w]*doorframe[\w]*", 20, True)

    found = client.simSetSegmentationObjectID("[\w]*sign[\w]*", 22, True)
    found = client.simSetSegmentationObjectID("[\w]*Sign[\w]*", 22, True)

    found = client.simSetSegmentationObjectID("[\w]*light[\w]*", 17, True)
    found = client.simSetSegmentationObjectID("[\w]*tunnel_light[\w]*", 17, True)
    ...
    found = client.simSetSegmentationObjectID("[\w]*SM_train[\w]*", 31, True)

    found = client.simSetSegmentationObjectID("[\w]*wall[\w]*", 3, True)
    found = client.simSetSegmentationObjectID("[\w]*Wall[\w]*", 3, True)
    found = client.simSetSegmentationObjectID("[\w]*doorwallset[\w]*", 3, True)
    """
