...
def Dict_indexing():
    ...
    Dict['floor'] = {'index': 5, 'subnames': []}
    Dict['wall'] = {'index': 13, 'subnames': []}
    Dict['ceiling'] = {'index': 3, 'subnames': []}
    Dict['pipe'] = {'index': 2, 'subnames': []}
    Dict['box'] = {'index': 23, 'subnames': []}
    Dict['extinguisher'] = {'index': 29, 'subnames': []}
    Dict['wallbox'] = {'index': 25, 'subnames': ['switch']}
    Dict['door'] = {'index': 20, 'subnames': ['doorframe']}
    Dict['sign'] = {'index': 22, 'subnames': []}
    Dict['light'] = {'index': 17, 'subnames': ['tunnel_light', 'lamp']}

    Dict['ladder'] = {'index': 27, 'subnames': []}
    Dict['barrel'] = {'index': 21, 'subnames': ['barel']}
    Dict['hand_truck'] = {'index': 31, 'subnames': []}
